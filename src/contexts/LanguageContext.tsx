...
const translations = {
  fr: {
    ...
    'activities.filter.status': 'Filtrer par statut',
    'activities.filter.tags': 'Filtrer par tags',
    'activities.filter.all': 'Toutes',
    'activities.filter.active': 'Actives',
    'activities.filter.archived': 'Archivées',
    'activities.filter.clear': 'Effacer les filtres',
    'activities.filter.showing': 'Affichage de',
    'activities.filter.results': 'résultats',
    'activities.filter.no-results': 'Aucune activité trouvée',
    'activities.filter.try-different': 'Essayez un autre filtre',
    'activities.status.active': 'Active',
    'activities.status.archived': 'Archivée',
...
Que la paix, la miséricorde et les bénédictions de Dieu soient sur vous.`
  ...
  ar: {
    ...
    'activities.filter.status': 'تصفية حسب الحالة',
    'activities.filter.tags': 'تصفية حسب العلامات',
    'activities.filter.all': 'الكل',
    'activities.filter.active': 'نشطة',
    'activities.filter.archived': 'مؤرشفة',
    'activities.filter.clear': 'مسح المرشحات',
    'activities.filter.showing': 'عرض',
    'activities.filter.results': 'نتائج',
    'activities.filter.no-results': 'لم يتم العثور على أنشطة',
    'activities.filter.try-different': 'جرب مرشحاً آخر',
    'activities.status.active': 'نشط',
    'activities.status.archived': 'مؤرشف',
